...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="editarusuario.php">Editar Usuario</a>
    ...
    <!--Seleccionamos Usuario-->
        <form class="formularioaltera" action="editarusuario.php"  method="POST">
                    <fieldset>
                    <div class="contenedorcat">
                        <div class="campo">
                            <label for="">Selecciona el usuario a editar:</label>
        ...
        <?php if ($usuario != "") { ?>
        <form class="formularioprod" action="<?php echo '../funciones/updateUsuario.php?id='. $id?>" method="POST">
            <fieldset>
                <legend>Ingrese la nueva Información del Usuario</legend>
                <?php while ($row = mysqli_fetch_array($usuario)) { ?>
                <div class="contenedor-campos">
                    <div class="campo">
                        <label for="">UserName</label>
                        <input class="input-text" type="text" name="newuser" value="<?php echo $row['username']; ?>" required>
                    </div>

                    <div class="campo">
                        <label for="">Password</label>
                        <input class="input-text" type="password" name="newpassword" value="" required>
                    </div>

                    <div class="campo">
                        <label for="">Nombre de Empleado</label>
                        <input class="input-text" type="text" name="newnombre" value="<?php echo $row['nombre']; ?>" required>
                    </div>
                </div>
