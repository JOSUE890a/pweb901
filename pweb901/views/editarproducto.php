...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="editarproducto.php">Editar Producto</a>
    ...
    <!--Seleccionamos Producto-->
        <form class="formularioaltera" action="editarproducto.php"  method="POST">
                    <fieldset>
                    <legend>Editar Producto</legend>
                    <div class="contenedorcat">
                        <div class="campo">
                            <label for="">Selecciona el producto a editar:</label>
        ...
        <?php if ($producto != "") { ?>
        <form class="formularioprod" action="<?php echo '../funciones/updateProducto.php?id='. $id?>" method="POST" enctype="multipart/form-data">
            <fieldset>
                <legend>Ingrese la nueva Información del Producto</legend>
                <?php while ($row = mysqli_fetch_array($producto)) { ?>
                <div class="contenedor-campos">
                    <div class="campo">
                        <label for="">Producto</label>
                        <input class="input-text" type="text" name="producto" value="<?php echo $row['nombre']; ?>" required>
                    </div>
                    ...
                    <div class="campo">
                        ...
                        <?php while ($row2 = mysqli_fetch_array($listaCategorias)) { ?>
                            ...
                            {?>
                            <option value="<?php echo $row2['categoria'] ?>" selected><?php echo $row2['categoria']; ?></option>
                      <?php }//del if
                      else
                      { ?>
                        <option value="<?php echo $row2['categoria'] ?>"><?php echo $row2['categoria']; ?></option>
                        <?php }//del else
                    ...
                    <div class="campo">
                        ...
                        value="<?php echo $row['existencia'] ?>" required>
                    </div>
                    ...
                    <div class="campo">
                        ...
                        <input class="input-foto" name="foto" type="file">
                    </div>

                </div><!--.contenedor-campos-->

                <div class="alinear-derecha flex">
                    <input class="boton w-sm-100" type="submit" name="submit" value="Guardar Cambios">
                </div>
                <?php } ?>
